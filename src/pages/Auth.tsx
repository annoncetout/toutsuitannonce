            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              <TabsContent value="signup" className="space-y-4 mt-0">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Talla" required={tab === "signup"} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="whatsapp">Numéro WhatsApp</Label>
                  <div className="relative">
                    <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                    <Input id="whatsapp" type="tel" value={whatsapp} onChange={(e) => setWhatsapp(e.target.value)} placeholder="+221 77 000 00 00" className="pl-10" required={tab === "signup"} />
                  </div>
                </div>
              </TabsContent>
